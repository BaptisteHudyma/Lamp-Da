...
inline static std::map<::lampda::hal::gpio::DigitalPin::GPIO, voidFuncPtr> callbacksRisingEdge;
inline static std::map<::lampda::hal::gpio::DigitalPin::GPIO, voidFuncPtr> callbacksFallingEdge;
inline static std::map<::lampda::hal::gpio::DigitalPin::GPIO, voidFuncPtr> callbacksChange;
...
void update_callbacks()
{
  ...
  {
    const ::lampda::hal::gpio::DigitalPin::GPIO buttonPin = ::lampda::component::button::get_button_pin();
...
{
public:
  DigitalPinImpl(hal::gpio::DigitalPin::GPIO pin) : _pin(pin) {}
  ...
  void attach_callback(voidFuncPtr cllbk, hal::gpio::DigitalPin::Interrupt mode) const
  {
...
void hal::gpio::DigitalPin::disconnect() const
{
  // do nothing ?
  // TODO issue #132
}
