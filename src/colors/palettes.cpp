...
const palette_t PaletteCloudColors =
{
    Blue, DarkBlue, DarkBlue, DarkBlue,
...
{
    Black,Maroon,Black,Maroon,
    DarkRed,Maroon,DarkRed,DarkRed,
    DarkRed,Red,Orange,White,
...
{
    MidnightBlue,DarkBlue,MidnightBlue,Navy,
...
/// HSV Rainbow
const palette_t PaletteRainbowColors =
{
...
const palette_t PalettePartyColors =
{
...
{
    0xff3800, 0xff5300, 0xff6500, 0xff7300,
    0xff7e00, 0xff8912, 0xff932c, 0xff9d3f,
    0xffa54f, 0xffad5e, 0xffb46b,0xffbb78,
    0xffc184, 0xffc78f, 0xffcc99, 0xffd1a3
};

const palette_t PaletteHeatColors =
{
    0x000000, 0x330000, 0x660000, 0x990000, 0xCC0000,
...
uint32_t get_color_from_palette(const uint8_t index, const palette_t& palette, const uint8_t brightness)
{
    ...
    const uint8_t blendIndex = index & 0x0F;   // mask with 15 (get the less significant part, that will be the blend factor)
