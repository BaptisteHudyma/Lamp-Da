    ...
    case 1:
      {
        ...
        // Start pairing mode
        const bool hasPairedDeviceAndNoPairing =
                bsp::ble::is_bounded() and not bsp::ble::is_advertising() and not bsp::ble::is_connected();
        ...
        else
        {
          ...
          const bool isNotCurrentlyPairing =
                  not(bsp::ble::is_advertising() and bsp::ble::is_open_to_all()) and not bsp::ble::is_connected();
          ...
          {
            // Start pairing mode
            bsp::ble::start_advertising(true);
