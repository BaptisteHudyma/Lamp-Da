...
#define FUSB_SWITCHES1_SPECREV(n)    (n << FUSB_SWITCHES1_SPECREV_SHIFT)
...
#define FUSB_CONTROL3_RETRIES_MASK    (0x03 << 1)
#define FUSB_CONTROL3_N_RETRIES_SHIFT 1
#define FUSB_CONTROL3_N_RETRIES(n)    (n << FUSB_CONTROL3_N_RETRIES_SHIFT)
...
#define FUSB_POWER_PWR3 (1 << 3) // enable internal oscillator
#define FUSB_POWER_PWR2 (1 << 2) // Measure block powered
#define FUSB_POWER_PWR1 (1 << 1) // receiver powerd and current reference for Measur block
#define FUSB_POWER_PWR0 1        // bandgap and wait circuitry
