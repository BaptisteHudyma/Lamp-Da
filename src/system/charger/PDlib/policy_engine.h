...
public:
  ...
  bool isNotPowerDelivery() { return state == policy_engine_state::PESinkSourceUnresponsive; }
...
private:
  ...
  policy_engine_state pe_start_message_tx(policy_engine_state postTxState,
                                          policy_engine_state txFailState,
                                          pd_msg* msg);
