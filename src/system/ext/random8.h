...
LIB8STATIC_ALWAYS_INLINE void random16_set_seed(uint16_t seed) { rand16seed = seed; }

/// Get the current seed value for the random number generator
LIB8STATIC_ALWAYS_INLINE uint16_t random16_get_seed() { return rand16seed; }

/// Add entropy into the random number generator
LIB8STATIC_ALWAYS_INLINE void random16_add_entropy(uint16_t entropy) { rand16seed += entropy; }
