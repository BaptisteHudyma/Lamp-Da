 ...
 * the number of consequtive clicks detected \param[in] clickHoldSerieCallback A
 * callback for a seri of clicks followed by a long hold. Parameter is the
 * number of consequtive clicks detected and the time of the old event (in
 * milliseconds). Called at until the button is released
 */
